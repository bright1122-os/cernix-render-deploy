    ...
    <div class="admin-section-body">
        <div class="admin-table-wrap">
            <table class="admin-table">
                <thead><tr><th>Name</th><th>Username</th><th>Role</th><th>Status</th><th>Total</th><th>Approved</th><th>Rejected</th><th>Duplicate</th><th>Last Active</th><th>Action</th></tr></thead>
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="10"><div class="admin-empty">No users configured yet.</div></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
