    ...
    <div class="doc-body">
        ...
        <div class="doc-section">
            ...
            <p>
                ...
                application, protected with AES-256-GCM and HMAC-SHA256, and checked against the token
                lifecycle before a student is admitted.
            </p>
            <div class="doc-code">
...
<span class="c-key">4.</span> Server verifies token state and records the decision.
<span class="c-ok">APPROVED / REJECTED / DUPLICATE</span>
            ...
            <div class="doc-cards">
                <div class="doc-card emerald">
                    ...
                    <div class="card-desc">Authenticated encryption protects the QR pass data handled by the application.</div>
                </div>
                <div class="doc-card navy">
                    <div class="card-label">Signature</div>
                    <div class="card-title">HMAC-SHA256</div>
                    <div class="card-desc">Signed pass data helps the server detect tampering during verification.</div>
                </div>
                <div class="doc-card">
                ...
                <div class="doc-step">
                    ...
                    <div class="step-body">
                        ...
                        <div class="step-desc">
                            ...
                            The pass remains tied to the student, session, payment state, and one-time token lifecycle.
                        </div>
                ...
                <div class="doc-step">
                    ...
                    <div class="step-body">
                        ...
                        <div class="step-desc">
                            ...
                            at the student's QR code. The server verifies the pass, session, token state, and scan context
                ...
                <div class="doc-step">
                    ...
                    <div class="step-body">
                        ...
                        <div class="step-desc">
                            ...
                            or <strong>amber (Duplicate)</strong>. Each decision is recorded with enough operational context
        ...
        <div class="doc-section">
            ...
            <div class="doc-info-block">
                ...
                <div class="doc-info-row">
                    ...
                    <div class="dir-val">PostgreSQL on Render, with local database options for development — students, payments, scan logs, sessions, and token state</div>
                </div>
                <div class="doc-info-row">
                ...
                <div class="doc-info-row">
                    ...
                    <div class="dir-val">Python risk analyzer — offline report generation and Admin Intelligence summaries without handling secrets or QR verification</div>
                </div>
                <div class="doc-info-row">
