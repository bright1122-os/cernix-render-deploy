...
<div class="cx-page-head"><div class="cx-eyebrow">School Fees Proof</div><h1>Payment</h1><p>Your school fees Remita verification record for the active exam session.</p></div>
<section class="cx-card cx-card-pad">
    @if($payment)
    <div class="cx-metric-grid">
        <div class="cx-metric"><span>Status</span><b>Verified</b></div>
        <div class="cx-metric"><span>RRR</span><b class="mono cx-safe">{{ $payment->rrr_number }}</b></div>
